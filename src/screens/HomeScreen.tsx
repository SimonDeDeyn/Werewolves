...
export default function HomeScreen({ onNavigate }: Props) {
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center px-6 pt-[calc(3.75rem+env(safe-area-inset-top))] pb-[max(1.5rem,env(safe-area-inset-bottom))] pr-[max(1.5rem,env(safe-area-inset-right))] pl-[max(1.5rem,env(safe-area-inset-left))] text-center">
